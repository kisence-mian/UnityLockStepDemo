Shader "T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bump Specular Mobile" {
Properties {
...
CGPROGRAM
#pragma surface surf T4MBlinnPhong exclude_path:prepass noforwardadd nolightmap approxview  
