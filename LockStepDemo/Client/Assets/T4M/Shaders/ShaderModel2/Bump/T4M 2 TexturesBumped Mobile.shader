Shader "T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bumped Mobile" {
Properties {
...
SubShader {
	...
	LOD 250
CGPROGRAM
#pragma surface surf T4M exclude_path:prepass noforwardadd  nolightmap approxview halfasview 
