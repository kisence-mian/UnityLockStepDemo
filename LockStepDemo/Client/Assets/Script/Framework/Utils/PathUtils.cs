...
namespace HDJ.Framework.Utils
{
    public class PathUtils
    {
        ...
        public static string[] GetDirectoryFilePath(string path, string[] endsWith = null)
        {
        ...
        /// <returns></returns>
        public static string[] GetDirectoryFileNames(string path, string[] endsWith, bool isNeedExtension = false)
        {
            string[] temps = GetDirectoryFilePath(path, endsWith);
