...
namespace Protocol
{
	...
	{
		[MessageMode(SendMode.ToClient)] 
		public class createitemcmd_c : CommandBase 
		{
			public List<p_map_item> list;
			public float m_executetime;
		}
		[MessageMode(SendMode.ToServer)] 
		public class createitemcmd_s : CommandBase 
		{
			public int m_itemid;
		...
		[MessageMode(SendMode.ToClient)] 
		public class fight_cancel_c : CommandBase 
		{
			public int code;
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_cancel_s : CommandBase 
		{
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_rank_c : CommandBase 
		{
			public List<p_rank> lists;
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_match_c : CommandBase 
		{
			public int code;
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_match_s : CommandBase 
		{
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_loading_c : CommandBase 
		{
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_loading_s : CommandBase 
		{
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_setelement_c : CommandBase 
		{
			[Int16]
			public int code;
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_setelement_s : CommandBase 
		{
			[Int16]
			public int item1;
			[Int16]
		...
		[MessageMode(SendMode.ToClient)] 
		public class fight_item_num_c : CommandBase 
		{
			public int id;
			[Int8]
			public int num;
		...
		[MessageMode(SendMode.ToClient)] 
		public class fight_element_c : CommandBase 
		{
			public List<p_item_info> list;
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_setrole_c : CommandBase 
		{
			[Int16]
			public int code;
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_setrole_s : CommandBase 
		{
			public string id;
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_end_c : CommandBase 
		{
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_end_s : CommandBase 
		{
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_item_list_c : CommandBase 
		{
			public List<p_item_info> lists;
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_use_item_c : CommandBase 
		{
			[Int16]
			public int code;
			public int id;
		...
		[MessageMode(SendMode.ToServer)] 
		public class fight_use_item_s : CommandBase 
		{
			public int id;
		}
		[MessageMode(SendMode.ToClient)] 
		public class fight_relive_c : CommandBase 
		{
			[Int16]
			public int code;
		}
		[MessageMode(SendMode.ToServer)] 
		public class fight_relive_s : CommandBase 
		{
		}
	}
	#endregion 
