...
public class CreatMesh : MonoBehaviour
{
    ...
    public void SetMesh(CharacterBase character, string areaID, bool isEnemy, string textureID)
    {
        AreaDataGenerate areaData = DataGenerateManager<AreaDataGenerate>.GetData(areaID);
        Vector3 AreaDir = Area.GetAreaDir(areaData, character, null);
        ...
        segments = 40;
        high = (int)areaData.m_Length;
        width = (int)areaData.m_Width;
