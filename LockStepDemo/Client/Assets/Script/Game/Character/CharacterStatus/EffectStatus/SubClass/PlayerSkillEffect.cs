...
public class PlayerSkillEffect:SkillStatus {
    ...
    public override void EnterSkillBefore()
    {
        ...
        if (m_currentSkillData.GetInfo().m_IsAreaTip)
        {
            ...
            RangeTip.SetMesh(m_character, m_currentSkillData.GetInfo().m_EffectArea, false, m_currentSkillData.GetInfo().m_AreaTexture);
        }
    }
