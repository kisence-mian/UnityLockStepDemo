...
public class DropDataGenerate : DataGenerateBase 
{
	public string m_key;
	...
	public int m_num10; //物品数量
	public int m_rate10; //物品概率

	public override void LoadData(string key) 
	{
		DataTable table =  DataManager.GetData("DropData");

		if (!table.ContainsKey(key))
		{
			throw new Exception("DropDataGenerate LoadData Exception Not Fond key ->" + key + "<-");
		}
