...
//dialogue_chs_11Generate类
//该类自动生成请勿修改，以避免不必要的损失
public class dialogue_chs_11Generate : DataGenerateBase 
{
	public string m_key;
	...
	{
		DataTable table =  DataManager.GetData("dialogue_chs_11");

		if (!table.ContainsKey(key))
		{
			throw new Exception("dialogue_chs_11Generate LoadData Exception Not Fond key ->" + key + "<-");
		}
