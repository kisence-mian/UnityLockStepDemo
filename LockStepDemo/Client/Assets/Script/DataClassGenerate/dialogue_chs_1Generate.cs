...
//dialogue_chs_1Generate类
//该类自动生成请勿修改，以避免不必要的损失
public class dialogue_chs_1Generate : DataGenerateBase 
{
	public string m_key;
	...
	{
		DataTable table =  DataManager.GetData("dialogue_chs_1");

		if (!table.ContainsKey(key))
		{
			throw new Exception("dialogue_chs_1Generate LoadData Exception Not Fond key ->" + key + "<-");
		}
